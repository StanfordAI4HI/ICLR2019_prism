...
for ((i=1; i<=$1; i++)); do
   seed=$(($2+$i))
   OMP_NUM_THREADS=1 python gibbs.py train 1001 $dataset --data_config '38-3-1-10-20-3' --log_freq 10 --n_iters 501 --seed $seed \
...
for ((i=1; i<=$1; i++)); do
   seed=$(($2+$i))
   OMP_NUM_THREADS=1 python gibbs.py train 1010 $dataset --data_config '38-3-1-10-20-3' --log_freq 10 --n_iters 501 --seed $seed \
   --log $log --p_type ind --a_type tied-across --s_model 25 --k_model -1 --gamma 1.0 --delta 0.1 &
done
...
for ((i=1; i<=$1; i++)); do
   seed=$(($2+$i))
   OMP_NUM_THREADS=1 python gibbs.py train 1100 $dataset --data_config '38-3-1-10-20-3' --log_freq 10 --n_iters 501 --seed $seed \
   --log $log --p_type ind --a_type tied-across --s_model 25 --k_model -1 --gamma 1.0 --delta 0.1 &
done
...
for ((i=1; i<=$1; i++)); do
   seed=$(($2+$i))
   OMP_NUM_THREADS=1 python gibbs.py train 1001 $dataset --data_config '38-3-1-15-20-3' --log_freq 10 --n_iters 501 --seed $seed \
   --log $log --p_type ind --a_type tied-across --s_model 25 --k_model -1 --gamma 1.0 --delta 0.1 &
done
